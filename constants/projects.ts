export const listProjects = [
  // W-Bench
  {
    ...
    overview: {
      description:
        'W-Bench is a web-based internal enterprise system designed to manage and monitor company data across multiple divisions within BRI.\n\nThe platform provides various modules to support business operations, including client management, sales pipeline tracking, approval workflows, and performance monitoring. This project was developed in multiple phases, and I contributed during Phase 2, focusing on enhancing existing features and improving the user interface and experience.',
    },
    problemStatement: [
      'Existing system required further development to support growing business needs across divisions',
      'Complex internal data spread across multiple modules, making it difficult to access and manage efficiently',
      'Inconsistent UI and user experience across different features',
      'Lack of clear visualization for performance and pipeline tracking',
      'Need for improved usability to support daily operational workflows',
    ],
    solution: [
      'Contributed to Phase 2 development, focusing on improving and enhancing existing system features',
      'Redesigned and refined UI components to create a more consistent and user-friendly interface',
      'Improved data structure and layout for better readability and accessibility',
      'Enhanced key modules such as Client Performance, Sales Pipeline, Approval System, and Lead Management',
      'Simplified navigation and workflows across multiple divisions',
      'Ensured consistency in design system and interaction patterns',
    ],
    uiDesign: {
      designSystem: {
        primaryColor:
          'Blue (#00549E) (represents trust, stability, and corporate professionalism)',
        secondaryColor:
          'Orange (#EA7D2A) (represents action, attention, and workflow interaction)',
        neutralColor: 'Gray scale (background & layout)',
        typography: 'Plus Jakarta Sans',
        gridSystem: '8pt spacing',
      },
      highlights: [
        'Sidebar navigation with structured modules (Client Limit, Benchmark, Client Performance, Pricing Calculator, Sales Pipeline, My Approval, Leads Management, Settings)',
        'Data-heavy tables with clear structure',
        'Pipeline and performance tracking views',
        'Organized module grouping for better navigation',
    ...
    challengesAndSolutions: {
      challenges: [
        'Working on an existing system with established structure (Phase 2 development)',
        'Ensuring consistency across multiple modules and features',
        'Managing complex and data-heavy enterprise UI',
        'Improving usability without disrupting existing workflows',
      ],
      solutions: [
        'Analyzed existing system and identified areas for UI/UX improvement',
        'Standardized components and layouts across modules',
        'Simplified complex data presentation into more structured views',
        'Maintained familiarity while improving usability and visual clarity',
      ],
    },
    learnings: [
      'Gained experience working on enterprise-level systems with multiple modules',
      'Learned how to contribute to ongoing projects (multi-phase development)',
      'Improved ability to handle complex and data-heavy UI systems',
      'Strengthened understanding of consistency in large-scale design systems',
      'Developed skills in enhancing existing products without breaking workflows',
    ],
    resultImpact: [
      'Improved usability and consistency across multiple system modules',
      'Enhanced clarity of data presentation for better decision-making',
      'Simplified navigation and workflow across divisions',
      'Contributed to a more scalable and maintainable design system',
      'Supported ongoing development of a large-scale enterprise application',
    ],
  },
  // Worksheet
  {
  ...
  // MotionBank
  {
    ...
    overview: {
      description:
        'This project focuses on designing an additional feature for the MotionBank mobile application, specifically a reward points redemption system.\n\nThe feature allows users to view their accumulated points, track point history, and redeem points into various reward categories such as e-vouchers, e-wallet balances, travel services, and electronic products. The goal was to enhance user engagement by providing a clear and flexible reward redemption experience.',
    },
    problemStatement: [
      'No dedicated feature to manage and utilize reward points effectively',
      'Lack of transparency regarding how points are earned and used',
      'Difficulty for users to track point history and redemption activities',
      'Limited flexibility in redeeming points across different reward categories',
      'No clear flow for combining points with other payment methods',
    ],
    solution: [
      'Designed a reward points feature including point balance overview, source of earned points, and point usage history',
      'Created a structured redemption system with multiple categories: E-voucher, E-wallet, Travel, and Electronics',
      'Implemented a hybrid payment flow, allowing users to redeem using points only or combine points with account balance',
      'Designed a clear and intuitive user flow for browsing rewards, selecting items, and completing redemption',
    ],
    uiDesign: {
      designSystem: {
        primaryColor:
          'Blue (#2C6F9F) (represents trust, security, and financial reliability)',
        secondaryColor:
          'Gold / Amber (#D7A22B)(represents rewards, value, and user incentives)',
        neutralColor: 'Gray scale (background & layout)',
        typography: 'Plus Jakarta Sans',
        gridSystem: '8pt spacing',
      },
      highlights: [
        'Point balance card with clear visibility',
        'Transaction history for earned and used points',
        'Category-based reward browsing',
        'Detailed reward page with redemption options',
        'Clear CTA for redemption actions',
        'Smooth flow for hybrid payment (points + balance)',
      ],
    },
    frontEndImplementation: null,
    challengesAndSolutions: {
      challenges: [
        'Designing a feature that integrates seamlessly into an existing fintech application',
        'Ensuring clarity in point calculation and usage history',
        'Creating a flexible redemption system with multiple reward categories',
        'Designing a hybrid payment flow (points + balance) without confusing users',
      ],
      solutions: [
        'Designed a clear information hierarchy for points, history, and rewards',
        'Simplified complex flows into intuitive and guided user interactions',
        'Used category-based navigation to organize reward options',
        'Created a structured redemption flow with clear steps and feedback',
        'Ensured consistency with existing app design system',
      ],
    },
    learnings: [
      'Gained experience designing feature enhancements in fintech applications',
      'Improved understanding of reward systems and user engagement strategies',
      'Learned how to design hybrid payment flows (points + balance)',
      'Strengthened ability to maintain design consistency within existing systems',
      'Developed skills in structuring transaction history and financial data UI',
    ],
    resultImpact: [
      'Improved user engagement by introducing a structured reward redemption system',
      'Increased transparency in point usage through clear history tracking',
      'Enhanced user experience with a flexible and intuitive redemption flow',
      'Provided scalable design for future reward and loyalty feature expansion',
    ],
  },
  // MBINET
  {
